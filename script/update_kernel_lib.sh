...
echo "移除老的内核开发包："
yum remove kernel-core-5.14.0-202.el9.x86_64 \
...
echo "安装新的内核开发包："
yum --enablerepo=elrepo-kernel install kernel-lt-devel kernel-lt-headers kernel-lt-tools kernel-lt-tools-libs kernel-lt-tools-libs-devel kernel-lt-doc gcc
